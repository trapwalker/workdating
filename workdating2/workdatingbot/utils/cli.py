...
@click.group()
def cli():
    from workdatingbot import misc
    from workdatingbot.utils import logging
...
def polling(skip_updates: bool):
    ...
    from workdatingbot.utils.executor import runner
...
def superuser(user_id: int, remove: bool):
    from workdatingbot.utils.executor import runner
    from workdatingbot.utils.superuser import create_super_user
